...
\textbf{Hierarchical models reflect the clustered structure of contemporary health care delivery most realistically, and can be used to address incomplete records.}
...
\subsubsection*{A suite of pre-compiled \textit{Stan} programs allows for a simple call to sophisticated modeling functions.} \textit{rstanarm} already implements many generalized linear 
...
Implemented in in \href{http://shiny.rstudio.com/}{\textit{Shiny}}, \textit{shinystan} is an R package for interactive web applications \cite{shinystan-software:2015,shinystan}. Data scientist already use generic extractor functions such as print() and coef(), but often lack a suitable 
